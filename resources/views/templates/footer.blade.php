<footer class="py-5 px-5 mt-5 bg-dark text-light">
    <div class="container">
        <div class="row d-flex justify-content-between">
            <div class="col-md-4 text-center">
                <div class="d-flex justify-content-center align-items-center gap-3 mb-4">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                        fill="currentColor" class="feather feather-map-pin">
                        <path
                            d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5S10.62 6.5 12 6.5s2.5 1.12 2.5 2.5S13.38 11.5 12 11.5z" />
                    </svg>
                    <h4 class="m-0">KANTOR</h4>
                </div>
                <p>Komplek Lorem ipsum <br>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Cupiditate
                    necessitatibus beatae animi sunt quisquam voluptatibus esse eveniet molestiae fugit optio.</p>
                ...
                <div class="d-flex justify-content-center align-items-center gap-3 mb-4">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
                        <path fill="currentColor"
                            d="M4 6V4h.1C12.9 4 20 11.1 20 19.9v.1h-2v-.1C18 12.2 11.8 6 4 6m0 4V8a12 12 0 0 1 12 12h-2A10 10 0 0 0 4 10m0 4v-2a8 8 0 0 1 8 8h-2a6 6 0 0 0-6-6m0 2a4 4 0 0 1 4 4H4z" />
                    </svg>
                    <h4 class="m-0">SOSIAL MEDIA</h4>
                </div>
            ...
            <div class="col-md-4 text-center">
                ...
                <p>08123456789 <br> email@example.com <br> email@example.com</p>
            </div>
        </div>
    </div>
</footer>
